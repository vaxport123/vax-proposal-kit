---
name: vax-proposal
description: 입찰 제안 하네스 — 「도전」 공고의 재료 팩(정량 지표·회사 자료·RFP 추출)을 위키에서 당겨와 P1 평가표 검산 → P2 가점 게이트 → P3 레퍼런스 → 방향·전략 → P4 초안+검토 → P5 심사 게이트(80점) → P6 슬라이드 계획 → Figma 까지 게이트 기반으로 진행한다. 표준 명령은 **「{정확한 제안서명} {A4|A3} {횡|종} 제안」**(예: 「순천캠퍼스 VR 실습실 구축 A4 횡 제안」) — 제안서명·용지·방향 셋을 인자로 받는다. "공고번호 + 제안" 또는 "/bid-loop 사업폴더"도 된다. 직원이 「준비 점검」「새 사업 접수」「제안서 시작」「입찰 제안」「고스트 덱」「덱 만들어」「회고」라고 해도 이 스킬이다 — 첫 동작은 P-1 준비 점검, 그다음 P-0 접수(RFP·연결·방향·재료를 묻는다).
---
