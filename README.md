...
> **"https://app.notion.com/p/f6a9511dd2264056931a1e9581727486 김승기 나만의 방식 알아서 기록"** → 가장 짧은 형태. 이름을 잡고 내 페이지를 찾거나 만들고 이 대화에서 정한 규칙을 저장한다.
> **"방식 저장: 한 문단에 숫자는 하나만"** · **"방식 불러와"** · **"방식 보기"** → 노션 「✍️ 제안 방식」 내 페이지에 저장·불러오기(사업 폴더 없이도, 어느 때든).
