...
`.claude/agents/`에 복사해 쓴다. `install.sh`가 이 폴더의 `*.md`(README 제외)를 `~/.claude/agents/`로 복사한다.
...
| 파일 | 자리 | 하는 일 |
|---|---|---|
| `proposal-critic.md` | P4 검토 ④ · P6 덱 계획 검토 | **비판자.** 한글 표현(A1 번역투 · A2 공문투 · A3 말은 되는데 뜻이 불분명한 문장 · A4 기계적 병렬 · A5 빈 수사 · A6 어려운 말 · A7 낭독 실패 · A8 회사명 가림 · A9 출처 없는 발주처 사실)과 AI 디자인(B1 같은 틀 반복 · B2 주장이 아닌 제목 · B3 제목 사슬 끊김 · B4 되풀이 · B5 글로 채운 장 · B6 장식 남용 · B7 헤더/쪽번호/목차 위반 · B8 빈 사진 자리 · B9 밀도 · B10 글자 크기 — B군은 경향 지적)을 잡는다. 표현은 직접 고쳐 새 판본을, 디자인은 슬라이드별 지시를 낸다. 사실·숫자는 바꾸지 않는다 (한준 2026-09-04) |
